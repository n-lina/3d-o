...
const CreateFigurine = () => {
  ...
  const sliderHeight = <Slider rootStyle={sliderStyle} domain={[10, 100]} step={1} mode={2} values={[figStore.height]} onUpdate={(val) => figStore.update_height(val[0])} >
    <Rail>
      {({ getRailProps }) => (
  ...
  const slider_dbottom = <Slider rootStyle={sliderStyle} domain={[1, 100]} step={1} mode={2} values={[figStore.dbottom]} onUpdate={(val) => figStore.update_dbottom(val[0])} >
  <Rail>
    {({ getRailProps }) => (
      <div style={railStyle} {...getRailProps()} />
    )}
  ...
  const slider_dtop = <Slider rootStyle={sliderStyle} domain={[1, 100]} step={1} mode={2} values={[figStore.dtop]} onUpdate={(val) => figStore.update_dtop(val[0])} >
  <Rail>
    {({ getRailProps }) => (
      <div style={railStyle} {...getRailProps()} />
    )}
  ...
  const top_rim_switch = <div className="switch"  style={{width: 100, height: 50}}>
      <SwitchSelector
          onChange={(val) => figStore.update_top_rim(val)}
          options={options}
          initialSelectedIndex={figStore.top_rim ? 0 : 1}
  ...
  const bottom_rim_switch = <div className="switch"  style={{width: 100, height: 50}}>
      <SwitchSelector
          onChange={(val) => figStore.update_bottom_rim(val)}
          options={options}
          initialSelectedIndex={figStore.bottom_rim ? 0 : 1}
          backgroundColor={"#FFE7E5"}
          fontColor={"#D75A58"}
          optionBorderRadius={30}
      />
  ...
  const lid_switch = <div className="switch"  style={{width: 100, height: 50}}>
      <SwitchSelector
          onChange={(val) => figStore.update_lid(val)}
          options={options}
          initialSelectedIndex={figStore.lid ? 0 : 1}
          backgroundColor={"#FFE7E5"}
          fontColor={"#D75A58"}
          optionBorderRadius={30}
      />
  ...
  <SwitchSelector
      onChange={(val) => figStore.update_curved_bottom(val)}
      options={options}
      initialSelectedIndex={figStore.curved_bottom ? 0 : 1}
      backgroundColor={"#FFE7E5"}
      fontColor={"#D75A58"}
      optionBorderRadius={30}
  />
  ...
  <SwitchSelector
      onChange={(val) => figStore.update_top_handle(val)}
      options={options}
      initialSelectedIndex={figStore.top_handle ? 0 : 1}
      backgroundColor={"#FFE7E5"}
      fontColor={"#D75A58"}
      optionBorderRadius={30}
  />
    ...
    <>
      <div className="container" style={{background: '#FFE7E5', display: 'flex', flexDirection:'row', width: 'auto', height: '690px'}}>
        ...
        <div className="containerRight" style={{width: '43%', height: '100%', overflow: 'visible', float:'right'}}>
          ...
          <div className="done-fig" style={{width: 80, marginBottom:35}}>
            <NavBtn>
