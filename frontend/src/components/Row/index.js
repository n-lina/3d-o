...
export default function Row(props) {
  const { width, selectedColor, offset, defaultColor, rowNum, oldDefault} = props;
  ...
  for (let i = 0; i < width; i++) {
    pixels.push(<Pixel key={i} selectedColor={selectedColor} defaultColor={defaultColor} oldDefault={oldDefault} />);
  }
